...
- **SEE ALL THE DATA BEFORE TAKING CONCLUSIONS**, you can increase the number of rows and columns that appears in your prints to respond the users questions with `pd.set_option('display.max_rows', None)` e `pd.set_option('display.max_columns', None)`
